...
/**
 * RatingBar    自定义打分控件RatingBar,可以自定义星星大小和间距
 * @author ZGQ
 * @version 1.0, 2017/10/10 0010
 * @since
 */
public class RatingStar extends LinearLayout {
    ...
    public RatingStar(Context context, AttributeSet attrs) {
        ...
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.RatingStar);
        starImageSize = mTypedArray.getDimension(R.styleable.RatingStar_starImageSize, 20);
        starPadding = mTypedArray.getDimension(R.styleable.RatingStar_starPadding, 10);
        starStep = mTypedArray.getFloat(R.styleable.RatingStar_starStep, 1.0f);
        stepSize = StepSize.fromStep(mTypedArray.getInt(R.styleable.RatingStar_stepSize, 1));
        starCount = mTypedArray.getInteger(R.styleable.RatingStar_starCount, 5);
        starEmptyDrawable = mTypedArray.getDrawable(R.styleable.RatingStar_starEmpty);
        starFillDrawable = mTypedArray.getDrawable(R.styleable.RatingStar_starFill);
        starHalfDrawable = mTypedArray.getDrawable(R.styleable.RatingStar_starHalf);
        mClickable = mTypedArray.getBoolean(R.styleable.RatingStar_clickable, true);
        mTypedArray.recycle();
