...
import com.longe.myresource.view.air_calendar.bean.CalendarDayModel;
import com.longe.myresource.view.air_calendar.bean.CalendarMonthModel;
...
public class MonthView extends View {
    ...
    private float todayCircleRadius;//今日小圆点
    ...
    private void init(AttributeSet attrs) {
        ...
        todayCirclePaint = new Paint(unavailableDayPaint);
        todayCirclePaint.setAntiAlias(true);
        todayCirclePaint.setStrokeWidth(2);
...
//        super.onDraw(canvas);
    ...
    private void drawMonthDay(Canvas canvas) {
        ...
        for (int i = 0; i < days.size(); i++) {
            ...
            if (day.isToday) {
//                //默认选中今日
//                if (day != null && dayClickListener != null && isFirst) {
...
//                }
                if (day.isSelected()) {
                    ...
                    todayCirclePaint.setColor(this.unavailableDayPaint.getColor());
                }
                todayCircleRadius = itemWidth/3;
                canvas.drawCircle(w + getPaddingLeft(), h + getPaddingTop(),
