...
public class MonthAdapter extends RecyclerView.Adapter<MonthAdapter.MonthHolder> implements MonthView.OnDayClickListener {
    ...
    public MonthHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.air_item, parent, false);
